...
#include "../../FinTool_V16/createaccount.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_createAccount_t, stringdata) + ofs \
...
void *createAccount::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_createAccount.stringdata))
