...
void FinTool::on_action_transaction_triggered(){
    ...
    if(transaction.success == true){
        ...
        currentTable->setItem(0,2, new QTableWidgetItem(transaction.transType));
        currentTable->setItem(0,3, new QTableWidgetItem(transaction.Category));
        currentTable->setItem(0,4, new QTableWidgetItem(QString::number(transaction.Amount)));
        currentTable->setItem(0,5, new QTableWidgetItem(transaction.Information));
